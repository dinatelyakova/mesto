...
export default class Card{
    constructor(data, {ownerId, handleCardClick, handleDeleteClick, handleLike}, elementSelector){
    ...
    isMyLike(likesArray, myUserId){
        return myUserId = likesArray.find(userSetLike=>userSetLike._id===myUserId)
